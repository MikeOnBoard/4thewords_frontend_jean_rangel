...
const LegendList: React.FC = () => {
  ...
  const confirmDelete = async () => {
    if (deleteModal.legendId) {
      setIsDeleting(true);
      try {
        await deleteLegend(deleteModal.legendId);
        setLegends(legends.filter(legend => legend.id !== deleteModal.legendId));
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            No hay leyendas que coincidan con los filtros aplicados o aún no se han agregado leyendas.
          </p>
